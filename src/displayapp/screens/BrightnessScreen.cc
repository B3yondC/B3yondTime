        ...
        : Screen(screenGraph, components)
{
        ...
        addOption(&FontAwesomeSolid24, SYMBOL_MAGIC, "Automagic");
...
void BrightnessScreen::updateCheckBoxes()
{
        ...
        for (OptionInfo *optionInfo : _optionInfos)
        {
                ...
                case 2:   // light
                        ...
                        break;
                case 3:   // automatic
                        checked = (currentLevel == BrightnessController::Levels::Automatic);
                        break;
                default:
                        break;
                }
...
void BrightnessScreen::optionClicked(int row)
{
        ...
        case 2:
                ...
                break;
        case 3:
                newLevel = BrightnessController::Levels::Automatic;
                break;
        default:
