...
#include "displayapp/screens/DigitalWatchFace.h"
...
ScreenGraph::ScreenGraph(SystemInterface *system, ComponentContainer *components)
{
        _system = system;
...
void ScreenGraph::switchScreen(ScreenTag tag, uint8_t pageNumber, TransitionEffect effect)
{
        ...
        case TransitionEffect::MoveLeft:
                _system->setFullRefreshDirection(SystemInterface::FullRefreshDirection::Right);
                break;
        case TransitionEffect::MoveRight:
                _system->setFullRefreshDirection(SystemInterface::FullRefreshDirection::Left);
                break;
        case TransitionEffect::MoveTop:
                _system->setFullRefreshDirection(SystemInterface::FullRefreshDirection::Up);
                break;
        case TransitionEffect::MoveBottom:
                _system->setFullRefreshDirection(SystemInterface::FullRefreshDirection::Down);
                break;
        default:
                break;
        }
...
Screen *ScreenGraph::createScreen(ScreenTag tag)
{
        ...
        case ScreenTag::DigitalWatchFace:
                return new DigitalWatchFace(this, _components);
